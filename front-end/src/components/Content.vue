          ...
          <el-tabs v-model="activeName">
            <el-tab-pane label="检测到的目标" name="first">
              ...
              <el-table
                ...
                style="width:80%;margin:15px auto 15px auto;text-align: center"
              >
                ...
                <el-table-column label="重量（单位：g）" width="250px">
                  <template slot-scope="scope">
                    <span>{{ scope.row[3] }}</span>
                  </template>
                </el-table-column>
                <el-table-column label="单价（单位：元/g）" width="250px">
                  <template slot-scope="scope">
                    <span>{{ scope.row[4]}}</span>
                  </template>
                </el-table-column>
                <el-table-column label="小计（单位：元）" width="250px" property="xiaoji">
                  <template slot-scope="scope">
  ...
  methods: {
      getSummaries(param){
          ...
          for(var i=0;i<data.length;i++){
            flag += data[i][3] * data[i][4];
          }
          if (column.property === 'xiaoji') {
            sums[index] = flag;
          } else {
          sums[index] = '--';
          }
    ...
    update(e) {
      ...
      axios
        ...
        .then((response) => {
          ...
          //this.$set(this.feat_list,item.tems13Gtoup,1);
          for (var i = 0; i < this.feat_list.length; i++) {
            response.data.image_info[this.feat_list[i]][0] = this.feat_list[i];
